  ...
  const certifications = [
    {
      ...
      link: "https://achieve.snowflake.com/96f561a6-2862-493e-bc01-5086ae1c8347#acc.PTxzJl7V",
    },
    {
      title: "Data Analyst",
    ...
    { title: "Data Science Course", issuer: "CEDLEARN", category: "Data Science", link: null },
    {
      title: "AWS AI-ML",
    ...
    <section id="publications" className="py-10 md:py-14 px-4 sm:px-6 lg:px-8">
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="grid gap-10">
          {/* Certifications */}
          <ScrollReveal>
            <Card className="border card-lift">
              <CardHeader className="pb-4">
                <div className="flex items-center gap-4">
                  <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-secondary to-primary flex items-center justify-center text-white flex-shrink-0 shadow-md">
              ...
              <CardContent>
                <div className="grid sm:grid-cols-2 gap-3">
                  {certifications.map((cert, index) => (
                    <div
                      key={index}
                      className="flex items-start gap-3 p-3.5 rounded-lg border border-border hover:bg-muted/50 hover:border-primary/20 transition-all duration-300 group"
                    >
          ...
          <ScrollReveal delay={0.15}>
            <Card className="border card-lift">
              <CardHeader className="pb-4">
                <div className="flex items-center gap-4">
                  <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-primary to-secondary flex items-center justify-center text-white flex-shrink-0 shadow-md">
              ...
              <CardContent className="space-y-4">
                ...
                <Button variant="outline" className="hover:bg-primary hover:text-primary-foreground transition-all duration-300" asChild>
